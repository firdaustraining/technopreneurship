                            ...
                            <div class="col-md-6">
                                <div class="form-group" wire:ignore>
                                    ...
                                    <select class="form-control select-bank-to" wire:model="bank_transfer_to" name="bank_transfer_to" required>
                                        <option value="">-- pilih BANK --</option>
                                        <option value="BCA - 1131458971 - AN. FIRDAUS AULIA FAZA"> BCA - 1131458971 |
                                            AN. FIRDAUS AULIA FAZA</option>
                                        <option value="MANDIRI SYARI'AH - 7130309725 - AN. FIRDAUS AULIA FAZA">
                                            MANDIRI SYARI'AH - 7130309725 | AN. FIRDAUS AULIA FAZA</option>
                                        <option value="JENIUS / BTPN - 90011961874 - AN. FIRDAUS AULIA FAZA"> JENIUS /
                                            BTPN - 90011961874 | AN. FIRDAUS AULIA FAZA</option>
                                    </select>
